...
the same host (independent review) -- proving the variable is the test JVM's console/terminal
...
Fix commit `7b8876bd` (test-only: 2 files). Verified by independent review:
