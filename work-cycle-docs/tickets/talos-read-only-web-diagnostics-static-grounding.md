...
- `work-cycle-docs/tickets/talos-static-verifier-web-app-scope-and-wording.md`
...
```text
work-cycle-docs/tickets/talos-read-only-web-diagnostic-loop-short-circuit.md
```
