...
- `work-cycle-docs/tickets/talos-mutation-prompt-empty-edit-args-recovery.md`
- `work-cycle-docs/tickets/talos-minimal-failure-policy.md`
Related tickets:
- `work-cycle-docs/tickets/talos-pre-approval-edit-arg-validation.md`
- `work-cycle-docs/tickets/talos-invalid-mutation-should-not-trigger-missing-mutation-retry.md`
