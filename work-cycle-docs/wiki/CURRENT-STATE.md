...
- Active tickets: T834 strong redaction; T835 chat transport localhost guard
  (implemented, open for review); T836 Windows protected-path canonicalization;
  T837 `run_command` output handoff boundary; T838 master-key custody.
...
- Next move: Wave 5 structural-decomposition closeout is owner-ratified;
  ...
  localhost guard, is implemented and open for review/closeout while
  T834/T836/T837/T838 remain open high-priority trust-surface fixes.
...
- T835: chat transport localhost guard, implemented and open for review.
