...
- Active tickets: nineteen open live-findings tickets carried into the main-merge
  ...
  Eleven deferred product/CLI findings: T885 (terminal UI for verification
  ...
  warning), T911 (read-only no-tool manifest evidence mismatch), and T912
  (Plan static-web false inspected-file claim). T866
