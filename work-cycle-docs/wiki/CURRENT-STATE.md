...
- Pre-release work after Wave 6 trust fixes is now ticketed from T842 onward:
  ...
  owner/independent review manual audit is now done (findings T866-T872). T853 is done after live
  `/set model ollama/...` -> `/context` review. T854 is closed after independent review live
...
T855 is done (independent review-verified). It hardens Talos's Ollama-independence truth
...
(independent review-verified incl. live smoke), completing the Ollama-independence arc
...
proves native/default tool-calling. T858 is done (independent review-verified): managed setup
...
DeepSeek is native-tool capable. T859 is done (independent review-verified): the REPL now says
