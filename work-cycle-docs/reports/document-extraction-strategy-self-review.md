...
| "Word support means Word support." | Ambiguous. Beta should say DOCX unless legacy DOC is implemented and tested. | `FileCapabilityPolicy` currently treats both `.doc` and `.docx` as unsupported. |
