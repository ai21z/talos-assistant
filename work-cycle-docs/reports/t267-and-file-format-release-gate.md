...
local coding assistant/leaked-source lessons: use only design lessons. Agent harnesses need explicit validation, permission checks, bounded loops, and artifact caution. No leaked implementation was copied.
