...
Reviewer: independent review grounding review, cross-verified by owner against disk
...
- independent review grounding review: CLEAN across the secret, private-mode, protected, and
...
- All 13 tools probed-or-explicitly-excluded-with-reason: the exercised tool
  ...
  T872).
- Truthfulness reviewed: independent review grounding review across all clusters, with the
