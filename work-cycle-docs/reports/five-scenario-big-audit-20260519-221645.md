...
- model provider agent eval guidance emphasizes scoring the trajectory/trace and final environment state, not only final answers: https://www.model provider.com/engineering/demystifying-evals-for-ai-agents
...
- GitHub AI assistant coding agent documentation emphasizes isolated work environments, session logs, diffs, and reviewable outputs: https://docs.github.com/en/AI assistant/using-github-AI assistant/coding-agent/about-assigning-tasks-to-AI assistant
