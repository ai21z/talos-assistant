...
| `external-review-wave6-deep-research-review-20260618.md` | 4,110 | tracked despite local ignore | Yes; direct test dependency | No | No detected | No detected | Already tracked; no action. |
