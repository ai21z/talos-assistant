...
| `opus-wave6-deep-research-review-20260618.md` | 4,110 | ignored/untracked | Yes; direct test dependency | No | No detected | No detected | Track as-is now with `git add -f`; this is the active clean-checkout break. |
