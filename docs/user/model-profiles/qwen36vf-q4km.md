...
GGUF file: `Qwen3.6-14B-A3B-VibeForged-v2-Q4_K_M.gguf`
...
```powershell
talos setup models --profile qwen36vf-q4km --server-path C:/path/to/llama-server.exe --write
```
