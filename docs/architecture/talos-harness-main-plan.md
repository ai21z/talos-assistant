...
### M6 — `assistant-instructions.md` stale — **STILL OPEN**
...
| M6 — `assistant-instructions.md` Talos rewrite | Low | Low | ⬜ | Docs only |
...
### N7 — `assistant-instructions.md` rewrite for Talos (M6)
