...
local coding assistant exposes read, edit/write, shell, and other tools through
...
- https://code.external assistant.com/docs/en/tools-reference
- https://code.external assistant.com/docs/en/settings
