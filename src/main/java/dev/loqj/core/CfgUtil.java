...
public final class CfgUtil {
    ...
    /**
     * Parse ENV vars with LOQJ__ prefix into a nested map.
     * Convention: LOQJ__rag__top_k=8 -> rag.top_k=8
    ...
    public static Map<String, Object> parseEnvOverrides() {
        ...
        System.getenv().forEach((key, val) -> {
            if (!key.startsWith("LOQJ__")) return;
            String rest = key.substring(6); // strip "LOQJ__"
