...
class PromptRouterTest {
    ...
    void workspace_without_question_stays_assist() {
        assertEquals(ASSIST, PromptRouter.route("I like workspaces in general"));
        assertEquals(ASSIST, PromptRouter.route("workspace is a cool concept"));
    }

    @Test
    void working_on_without_question_stays_assist() {
        assertEquals(ASSIST, PromptRouter.route("I'm working on something"));
        assertEquals(ASSIST, PromptRouter.route("still working on it"));
    }
    ...
    void exact_failing_prompts_now_route_to_assist() {
        assertEquals(ASSIST, PromptRouter.route("create a new empty file in this workspace called settings.json"));
        assertEquals(ASSIST, PromptRouter.route("list the files in the directory please"));
    }
